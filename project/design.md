...
------------------|------------------------------------------------------------------------|---------------------------------------------|------------------------
MOVE(p → p')       | robot en p; existe corredor (p,p'); entorno cumple los requisitos       | posición pasa a p';                         | costo_energía(p,p') + 1
                    | del corredor (si los hay); batería ≥ costo_energía(p,p')                | batería -= costo_energía(p,p')              |
------------------|------------------------------------------------------------------------|---------------------------------------------|------------------------
